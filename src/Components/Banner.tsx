...
// const Banner = () => {
//     return (
//         <section className="flex my-6 container mx-auto items-center gap-10 mt-20 mb-20">
//             <div className='mb-6'>
//                 <h2 className='font-bold text-6xl'>Build Your Ideal</h2>
//                 <h2 className='font-bold text-6xl mb-4 bg-linear-to-r from-orange-500 via-pink-700 to-violet-600 bg-clip-text text-transparent'>Development Stack</h2>
//                 <p className="text-xl text-gray-500">Explore frontend, backend, database, and tooling options, compare them side by side, and put together the stack that fits your
//                     next project.</p>
//                 <div className="flex gap-6 my-6 mt-15">
//                     <button className="btn bg-linear-to-r from-orange-500 to-pink-500 text-white px-6 py-2 rounded-lg">Explore Technologies</button>
...
//             <div>
//                 <img className = 'w-4xl' src={bannerLogo} alt="" />
//             </div>
//         </section>
