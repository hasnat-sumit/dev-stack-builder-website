    ...
    return (
        <section className="flex flex-col-reverse lg:flex-row my-6 container mx-auto items-center gap-10 mt-10 lg:mt-10 mb-10 lg:mb-10 px-4">
            <div className='mb-6 text-center lg:text-left'>
                ...
                <p className="text-base sm:text-md lg:text-md text-gray-500">
                    Explore frontend, backend, database, and tooling options, <br /> compare them side by side, and put together the stack that fits your next project.
                </p>
