# Dev Stack Builder
"Pick the right frontend, backend, database and tooling for your project."
...
- useEffect lets us run code in response to a component rendering or certain values changing. It was needed to load the JSON data.
...
A parent passes data down to a child using props. For a child to send data back up to the parent, the parent passes down a function as a prop, and the child calls that function with the data it wants to send. 
